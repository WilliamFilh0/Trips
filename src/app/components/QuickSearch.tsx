      ...
      <div className="flex w-full justify-between mt-5">
        <div className="flex flex-col items-center gap-1">
          ...
          >
            ...
            <p className="text-sn text-grayPrimary ">Hotel</p>
          </Link>
        </div>
        ...
        <div className="flex flex-col items-center gap-1">
          ...
          >
            ...
            <p className="text-sn text-grayPrimary ">Fazenda</p>
          </Link>
        </div>
        ...
        <div className="flex flex-col items-center gap-1">
          ...
          >
            ...
            <p className="text-sn text-grayPrimary ">Chalé</p>
          </Link>
        </div>
        ...
        <div className="flex flex-col items-center gap-1">
          ...
          >
            ...
            <p className="text-sn text-grayPrimary ">Pousada</p>
          </Link>
        </div>
      </div>
    </div>
